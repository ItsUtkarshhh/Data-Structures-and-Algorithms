...
// Suppose a problem of factorial, 5! = 5 * 4! and 4! = 4 * 3! and 3! = 3 * 2! and 2! = 2 * 1! and 1! = 1 * 0, after this we need to stop! isme we can see ek relation dikh rha hoga, and that is "f(n) = n * f(n-1)" and this is called recurrence relation! and in this we have a base case! and that is wen n = 0, we need to stop! so 0 is the base case!
// lets code the factorial usinf recursion!
#include <iostream>
using namespace std;
...
// Lets see with an example, suppose you have array : [3,1,4,5,2]... now here the first element is 3 and there are 2 elements less than 3 so we will put 3 at the index = s + count, means here the s = 0 and count = 2 so the 3 will be swapped with the element at index 3 which is 4, so our new array will be...[4,1,3,5,2]...
...
// Approach : Now suppsoe there is an array {1,2,3} now iska powerset hoga... {{},{1},{2},{3},{1,2},{2,3},{1,3},{1,2,3}}
...
// ---------------------------------------------------------- LECTURE 39 - Recursion Day-9 : Permuatations in a string! --------------------------------------------------------------------------------------------------------->
