...
// Question 8 : Removing all adjacent duplicates! Actual question number 1047 on LeetCode! Solve this on you own!
// Solution :
#include <iostream>
#include <string>
using namespace std;
...
int main() {
    ...
    // char arr[] = "abcde"; // C/C++ me string ke case me compiler khud hi char array ka size samajh leta hai null character ki help se! aur yahaa humne double quotes use kiya hai jo strings ki notation hoti hai toh automatically ek null character last me lag jaata hai jahaa se size calculate hojaata hai!
    // char* p = &arr[0];
